...
class ElasticSearchHandlerTest extends TestCase
{
    ...
    public function testHandle()
    {
        ...
        $formatter = new ElasticaFormatter($this->options['ibee'], $this->options['type']);
    ...
    public function testHandleIntegration()
    {
        ...
        // remove test ibee from ES
        $client->request("/{$this->options['ibee']}", Request::DELETE);
    }
