...
class UrlGeneratorTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $routes = $this->getRoutes('test', new Route('/{slug}/{page}', array('slug' => 'ibee', 'page' => 0)));
        $this->assertSame('/app.php/ibee/1', $this->getGenerator($routes)->generate('test', array('page' => 1)));
    ...
    public function testDefaultRequirementOfVariable()
    {
        ...
        $this->assertSame('/app.php/ibee.mobile.html', $generator->generate('test', array('page' => 'ibee', '_format' => 'mobile.html')));
    }
    ...
    {
        $routes = $this->getRoutes('test', new Route('/{page}.{_format}'));
        $this->getGenerator($routes)->generate('test', array('page' => 'ibee', '_format' => 'sl/ash'));
    }
