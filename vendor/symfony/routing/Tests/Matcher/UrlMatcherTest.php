...
class UrlMatcherTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $coll = new RouteCollection();
        $coll->add('test', new Route('/{page}.{_format}', array('page' => 'ibee', '_format' => 'html')));
    ...
    public function testDefaultRequirementOfVariable()
    {
        ...
        $this->assertEquals(array('page' => 'ibee', '_format' => 'mobile.html', '_route' => 'test'), $matcher->match('/ibee.mobile.html'));
    }
